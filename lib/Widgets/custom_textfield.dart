...
class custom_textfield extends StatelessWidget {
  ...
  const custom_textfield({Key? key, required this.inputDecoration, this.obscure_txt=false, this.txt_input_type=TextInputType.text,this.txtfield_color=Colors.white, this.txtfield_padding=10, required this.fieldValidator, required this.onsaved}) : super(key: key);
